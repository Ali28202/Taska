...
export default function Task() {
	return (
		<>
			<div className="w-full bg-white pl-5 pr-3 py-3 rounded-2xl border-slate-200 border-[1px]">
				...
				<div className="flex flex-col gap-5 mt-5">
					<h1 className="lg:text-xl text-lg font-medium">Wireframing</h1>
					<p className="2xl:w-80 xl:w-64 lg:w-56 lg:text-sm text-xs text-gray-500 leading-relaxed">
						Create low-fidelity designs that outline the basic structure and
						layout of the product or service...
					</p>
