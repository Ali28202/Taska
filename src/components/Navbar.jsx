...
export default function Navbar() {
	...
	return (
		<>
			{/* Desktop */}
			<div className="lg:flex hidden items-center xl:justify-between lg:justify-center lg:gap-48 my-5 gap-5 lg:px-6 bg-white pb-5 w-full border-b-2 border-slate-200">
				<TextField
					variant="outlined"
					placeholder="Search..."
